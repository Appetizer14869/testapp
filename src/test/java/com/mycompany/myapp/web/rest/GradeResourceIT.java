...
class GradeResourceIT {
    ...
    private static final Instant DEFAULT_DATE_AWARDED = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_AWARDED = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Grade createEntity() {
        return new Grade().score(DEFAULT_SCORE).remarks(DEFAULT_REMARKS).dateAwarded(DEFAULT_DATE_AWARDED);
    }
    ...
    public static Grade createUpdatedEntity() {
        return new Grade().score(UPDATED_SCORE).remarks(UPDATED_REMARKS).dateAwarded(UPDATED_DATE_AWARDED);
    }
    ...
    void getAllGrades() throws Exception {
        ...
        restGradeMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateAwarded").value(hasItem(DEFAULT_DATE_AWARDED.toString())));
    }
    ...
    void getGrade() throws Exception {
        ...
        restGradeMockMvc
            ...
            .andExpect(jsonPath("$.dateAwarded").value(DEFAULT_DATE_AWARDED.toString()));
    }
    ...
    void putExistingGrade() throws Exception {
        ...
        updatedGrade.score(UPDATED_SCORE).remarks(UPDATED_REMARKS).dateAwarded(UPDATED_DATE_AWARDED);
    ...
    void partialUpdateGradeWithPatch() throws Exception {
        ...
        partialUpdatedGrade.remarks(UPDATED_REMARKS).dateAwarded(UPDATED_DATE_AWARDED);
    ...
    void fullUpdateGradeWithPatch() throws Exception {
        ...
        partialUpdatedGrade.score(UPDATED_SCORE).remarks(UPDATED_REMARKS).dateAwarded(UPDATED_DATE_AWARDED);
