...
class SubjectResourceIT {
    ...
    public static Subject createEntity() {
        return new Subject().subjectName(DEFAULT_SUBJECT_NAME).description(DEFAULT_DESCRIPTION);
    }
    ...
    public static Subject createUpdatedEntity() {
        return new Subject().subjectName(UPDATED_SUBJECT_NAME).description(UPDATED_DESCRIPTION);
    }
    ...
    void putExistingSubject() throws Exception {
        ...
        updatedSubject.subjectName(UPDATED_SUBJECT_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateSubjectWithPatch() throws Exception {
        ...
        partialUpdatedSubject.subjectName(UPDATED_SUBJECT_NAME).description(UPDATED_DESCRIPTION);
