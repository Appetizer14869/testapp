...
describe('Subject e2e test', () => {
  ...
  const subjectSample = { subjectName: 'unlike naturally quash' };
  ...
  describe('new Subject page', () => {
    ...
    it('should create an instance of Subject', () => {
      cy.get(`[data-cy="subjectName"]`).type('determined above');
      cy.get(`[data-cy="subjectName"]`).should('have.value', 'determined above');
