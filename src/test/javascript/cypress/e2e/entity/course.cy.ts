...
describe('Course e2e test', () => {
  ...
  const courseSample = { title: 'sick freezing oof', credits: 22609 };
  ...
  describe('new Course page', () => {
    ...
    it('should create an instance of Course', () => {
      ...
      cy.get(`[data-cy="description"]`).type('save that');
      cy.get(`[data-cy="description"]`).should('have.value', 'save that');

      cy.get(`[data-cy="credits"]`).type('23064');
      cy.get(`[data-cy="credits"]`).should('have.value', '23064');
