...
describe('Student e2e test', () => {
  ...
  const studentSample = { firstName: 'Jenifer', lastName: 'Schowalter', email: 'Delaney2@hotmail.com' };
  ...
  describe('new Student page', () => {
    ...
    it('should create an instance of Student', () => {
      cy.get(`[data-cy="firstName"]`).type('Humberto');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Humberto');

      cy.get(`[data-cy="lastName"]`).type('Terry');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Terry');

      cy.get(`[data-cy="email"]`).type('Emory_Hamill@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Emory_Hamill@hotmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('even phooey nasalise');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'even phooey nasalise');

      cy.get(`[data-cy="enrollmentDate"]`).type('2025-09-06T12:49');
      cy.get(`[data-cy="enrollmentDate"]`).blur();
      cy.get(`[data-cy="enrollmentDate"]`).should('have.value', '2025-09-06T12:49');
