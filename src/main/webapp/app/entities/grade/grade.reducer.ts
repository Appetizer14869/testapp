...
export const createEntity = createAsyncThunk(
  'grade/create_entity',
  async (entity: IGrade) => {
    return axios.post<IGrade>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const updateEntity = createAsyncThunk(
  'grade/update_entity',
  async (entity: IGrade) => {
    return axios.put<IGrade>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IGrade) => {
    return axios.patch<IGrade>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IGrade>(requestUrl);
  },
  { serializeError: serializeAxiosError },
);
