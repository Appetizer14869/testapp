...
export const TeacherDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/teacher${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testappApp.teacher.delete.question">
        <Translate contentKey="testappApp.teacher.delete.question" interpolate={{ id: teacherEntity.id }}>
