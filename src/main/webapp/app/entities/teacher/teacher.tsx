...
export const Teacher = () => {
  ...
  const totalItems = useAppSelector(state => state.teacher.totalItems);
  ...
  return (
    <div>
      <h2 id="teacher-heading" data-cy="TeacherHeading">
        <Translate contentKey="testappApp.teacher.home.title">Teachers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="testappApp.teacher.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/teacher/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="testappApp.teacher.home.createLabel">Create new Teacher</Translate>
          </Link>
        </div>
      </h2>
        ...
        {teacherList && teacherList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="testappApp.teacher.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="testappApp.teacher.department">Department</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {teacherList.map((teacher, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{teacher.hireDate ? <TextFormat type="date" value={teacher.hireDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{teacher.salary}</td>
                  <td>{teacher.department ? <Link to={`/department/${teacher.department.id}`}>{teacher.department.id}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/teacher/${teacher.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/teacher/${teacher.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="testappApp.teacher.home.notFound">No Teachers found</Translate>
            </div>
          )
        )}
      </div>
